...
const int StimPin = 3;
const int BeepPin = 4;
const int servoPinMain = 9; // Servo that controls the pole
const int servoPinMask = 11; // Servo that masks the sound - both have to be the same type

// timing
unsigned long startTBeep;
const unsigned long beepDur=100000; 
...
const float galvoStart=40;
const float centerRight = 80;
